...
const routes: Routes = [
  ...
  {
    path: 'listagem-conta',
    loadChildren: () => import('./Pages/listagem/conta-listagem.module').then( m => m.ListagemPageModule)
  },
  {
    path: 'consulta-conta',
    loadChildren: () => import('./conta/consulta/conta-consulta.module').then( m => m.ConsultaPageModule)
  },
  {
    path: 'conta-consulta',
